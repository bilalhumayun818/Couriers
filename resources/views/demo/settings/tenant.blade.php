  ...
  <div class="card overflow-hidden">
    ...
    <div class="p-5 space-y-4">
      ...
      <div class="rounded-lg px-4 py-3" style="background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.08);">
        <p class="text-xs text-slate-400">Preview: <span class="font-semibold text-slate-100">$1,500.00</span></p>
      </div>
    </div>
  </div>
  ...
  <div class="card overflow-hidden">
    ...
    <div class="p-5 space-y-4">
      ...
      <div class="rounded-lg px-4 py-3 space-y-1.5" style="background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.08);">
        <p class="text-xs text-slate-300 font-semibold mb-2">Tax Calculation Preview — Fare: $420.00</p>
        <div class="flex justify-between text-xs text-slate-400"><span>Pre-tax Fare</span><span>$420.00</span></div>
    ...
    <div class="p-5 space-y-4">
      <div class="grid grid-cols-2 gap-4">
        ...
        <div>
          ...
          <input type="text" value="acme-logistics" class="w-full text-sm" style="background:rgba(255,255,255,0.04);opacity:0.7;" readonly>
        </div>
      </div>
    </div>
  </div>
